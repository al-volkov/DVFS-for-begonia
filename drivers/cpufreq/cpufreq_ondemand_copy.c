...
void od_register_powersave_bias_handler_copy(unsigned int (*f)
...
EXPORT_SYMBOL_GPL(od_register_powersave_bias_handler_copy);

void od_unregister_powersave_bias_handler_copy(void)
{
	od_ops.powersave_bias_target = generic_powersave_bias_target;
	od_set_powersave_bias(0);
}
EXPORT_SYMBOL_GPL(od_unregister_powersave_bias_handler_copy);
